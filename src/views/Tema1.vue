...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-lg-10
        .cajon.color-secundario.p-4.mb-4
          p Este procedimiento no solo asegura que la novedad se gestione correctamente, sino que también afianza en las competencias clave como atención al usuario, aplicación normativa, manejo documental, ética profesional y comunicación efectiva.
</template>
